	...
	export default {
		...
		methods:{
			getMsgList(){
				// 消息列表
				let list = [
					{id:0,uid:0,username:"大黑哥",face:"/static/img/face.jpg",time:"12:56",type:"text",msg:{content:"为什么房屋实物会相差那么大？"}},
					{id:1,uid:1,username:"房产客服008",face:"/static/img/im/face/face_2.jpg",time:"12:57",type:"text",msg:{content:"这个是有偏差的，差几米是正常的，测量问题，如果差十几米，那就是施工问题了。"}},
					{id:2,uid:1,username:"房产客服008",face:"/static/img/im/face/face_2.jpg",time:"12:59",type:"voice",msg:{url:"/static/voice/3.aac",length:"00:06"}},
					...
					{id:5,uid:1,username:"房产客服008",face:"/static/img/im/face/face_2.jpg",time:"12:59",type:"img",msg:{url:"/static/img/q.jpg",w:1920,h:1080}}
				]
				// 获取消息中的图片,并处理显示尺寸
...
<style lang="scss">
	@import "@/static/img/css/style.scss"; 
page{
