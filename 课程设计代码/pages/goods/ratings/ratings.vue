	...
	export default {
		data() {
			return {
				...
				labelIndex:0,
				ratingsList:[
					{id:1,username:"匿名用户1****",face:"/static/img/face.jpg",date:'2019-04-21',spec:"规格: 100㎡",grade:"good",
						first:{content:"房源不错，去实地考察过几次，环境很好！",
						...
						append:{date:65,content:"已经签了合同，经理态度很好。",
					...
					{id:2,username:"匿名用户3***",face:"/static/img/face.jpg",date:'2019-04-21',spec:"规格: 100㎡",grade:"secondary",
						first:{content:"好评，看图",
					...
					{id:3,username:"匿名用户2****",face:"/static/img/face.jpg",date:'2019-04-21',spec:"规格: 100㎡",grade:"poor",
						first:{content:"好评，看图",
						img:["https://ae01.alicdn.com/kf/HTB111soTbvpK1RjSZPiq6zmwXXaB.jpg","https://ae01.alicdn.com/kf/HTB1O2TRTmzqK1RjSZPcq6zTepXa4.jpg"],
						video:[]
						}
