	...
	<view>
		...
		<view class="header">
			...
			<view class="before" :style="{ opacity: 1 - afterHeaderOpacity, zIndex: beforeHeaderzIndex }">
				<view class="back"><view class="icon iconfont icon-back_icon-copy" @tap="back" v-if="showBack"></view></view> 
				<view class="middle"></view>
				<view class="icon-btn">
					<view class="icon tongzhi" @tap="toMsg"></view>
					<view class="icon iconfont icon-conversation_icon" @tap="joinCart"></view>
				</view>
			</view>
			<!-- 头部-滚动渐变显示 -->
		...
		<view class="footer">
			<view class="icons">
				<view class="box" @tap="share">
					<view class="icon iconfont icon-share_icon"></view>
					<view class="text">分享</view>
				</view>
				<view class="box" @tap="toChat">
					<view class="icon iconfont icon-service_icon"></view>
					<view class="text">客服</view>
				</view>
				<view class="box" @tap="keep">
					<view class="icon iconfont" :class="[isKeep?'icon-collect_icon':'icon-collect_icon-copy']"></view>
					<view class="text">{{isKeep?'已':''}}收藏</view>
				</view>
			</view>
			<view class="btn">
				<view class="joinCart" @tap="joinCart">加入收藏</view>
				<view class="buy" @tap="buy">立即咨询</view>
			</view>
		</view>
		<!-- share弹窗 -->
		...
		<view class="info-box comments" id="comments">
			<view class="row">
				<view class="text">讨论区({{goodsData.comment.number}})</view>
	...
	data() {
		return {
			...
			goodsData:{
				...
				number:1,
				service:[
					{name:"正品房源",description:"此房源官方保证真实有效"},
					{name:"精修交付",description:"此房屋已精修交付"},
					{name:"南北通透",description:"此房屋设计南北通透"}
				],
				spec:["90㎡","100㎡","105㎡","112㎡","150㎡","160㎡"],
				comment:{
					number:102,
					userface:'../../static/img/face.jpg',
					username:'匿名用户1****',
					content:'房源不错，去实地考察过几次，环境很好！'
				}
			},
